...
float loadA = 0; // kg
int analogvalA = 42; // analog reading taken with load A on the load cell

float loadB = 0.048; // kg
int analogvalB = 500; // analog reading taken with load B on the load cell
...
void loop() {
  ...
  if(millis() > time + timeBetweenReadings){
    ...
    Serial.print("read: ");Serial.print(analogValue);
